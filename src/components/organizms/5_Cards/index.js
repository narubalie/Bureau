  ...
  data () {
    return {
      ...
      },
      {
        ...
        type: 'Стоматолог',
        description: 'Зубы - моя любовь! Профессионально занимаюсь отбеливанием, анестезией и больше всего люблю ожерелья из зубов)',
        cover: require('../../../assets/elements/doctors/doc-16.png')
      }, {
        id: 7000,
        name: 'Актуальная Елена',
        isActive: true,
        type: 'Стоматолог',
        description: 'Зубы - моя любовь! Профессионально занимаюсь отбеливанием, анестезией и больше всего люблю ожерелья из зубов)',
        cover: require('../../../assets/elements/doctors/doc-17.png')
      },
      {
        id: 8000,
        name: 'Длиннофамильная Анна',
        ...
        isActive: true,
        description: 'Зубы - моя любовь! Профессионально занимаюсь отбеливанием, анестезией и больше всего люблю ожерелья из зубов)',
        cover: require('../../../assets/elements/doctors/doc-18.png')
      }, {
        id: 9000,
        name: 'Кроткая Семирамида',
        isActive: true,
        type: 'Стоматолог',
        description: 'Зубы - моя любовь! Профессионально занимаюсь отбеливанием, анестезией и больше всего люблю ожерелья из зубов)',
        cover: require('../../../assets/elements/doctors/doc-19.png')
      }, {
        id: 1100,
        name: 'Актуальная Елена',
        isActive: true,
        type: 'Стоматолог',
        description: 'Зубы - моя любовь! Профессионально занимаюсь отбеливанием, анестезией и больше всего люблю ожерелья из зубов)',
        cover: require('../../../assets/elements/doctors/doc-20.png')
      },
      {
        id: 1200,
        ...
        type: 'Стоматолог',
        description: 'Зубы - моя любовь! Профессионально занимаюсь отбеливанием, анестезией и больше всего люблю ожерелья из зубов)',
        cover: require('../../../assets/elements/doctors/doc-21.png')
      }]
    }
  },
  computed: {},
